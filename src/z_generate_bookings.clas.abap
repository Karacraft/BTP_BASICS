CLASS z_generate_bookings DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z_generate_bookings IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
    DATA:it_bookings TYPE TABLE OF ztbooking_d01.
...
*   Delete the possible entries in the database table - in case it was already filled
    DELETE FROM ztbooking_d01.
*   insert the new table entries
    INSERT ztbooking_d01 FROM TABLE @it_bookings.
